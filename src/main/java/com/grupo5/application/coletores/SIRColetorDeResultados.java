...
public class SIRColetorDeResultados implements StepHandler{
    ...
    private List<Double> rHistorico = new ArrayList<>();
    ...
    public List<Double> getRHistorico() {
        return new ArrayList<>(rHistorico);
    }
